...
function wpc_assets() {
    ...
    wp_enqueue_style('wpc_main_style_css', get_theme_file_uri("./css/style.css"), null, microtime());
    ...
    wp_enqueue_script( 'wpc_main_js', get_theme_file_uri("./js/script.js"), array('jquery'), '1.0', true );
}
